...
for (let i = 0; i<supplyChanges.length; i++ ) {
    ...
    }   else if (x === 0) {console.log('No change.');
...
for (element of supplyChanges) {
    if (element > 0) {console.log('Added ' + element + ' parts.');
    }   else if (element === 0) {console.log('No change.');
    }   else if (element < 0) {console.log('Removed ' + element + ' parts.');
}
}
...
console.log ('Leftover parts: ' + totalParts);
